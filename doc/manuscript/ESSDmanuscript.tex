...
required information, and added \# new records.
...
retrieve relevant information, including (1) whether data were presented
in tables / text or digitized from figures (EFDB will not accept
digitized data, whereas ForC does), (2) estimates in original units, and
(3) confidence intervals (when not already in ForC). We also checked
that existing ForC records were complete and correct.
...
As of April 18, 2022, we had reviewed and sent NA, NA of which have been
