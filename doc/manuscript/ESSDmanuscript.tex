...
required by EFDB and to improve ForC's capacity to serve as a repository
...
the ForC database, we added or modified \#\# fields (Appendix A),
defined 15 new variables, implemented enhanced quality control, manually
reviewed \textgreater\# records to obtain additional required
information, and added \# new records.
