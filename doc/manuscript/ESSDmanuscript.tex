...
The mapping of ForC fields into EFDB fields is documented in Appendix B.
...
mapped into the EFDB field \texttt{Region/Regionalconditions} (Appendix
...
field \texttt{Comments\ from\ Data\ Provider}). For some fields, simple
...
pertinent (\texttt{Gases} field) because these values could be used in
...
and (2) determination of land use categories (section 4.1.2).
