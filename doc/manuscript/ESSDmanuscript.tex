...
For C currently contains 39838 records from 10585 plots in 1531 distinct
...
As of April 18, 2022, we had reviewed and sent NA records to EFDB, 73 of
...
warrented given their importance for forest C accounting.} Given
...
\hline
forest census methods & Census stems down to the smallest diameter feasible. & IPCC biomass pool definition includes all living vegetation\\
\hline
 & taxa to include: & IPCC biomass pool definition includes all living vegetation\\
\hline
dead organic matter sampling & include damage estimates on standing dead trees & \\
\hline
 & adopt IPCC recommendations for min diameter of deadwood & \\
\hline
belowground sampling & Select soil sampling increments to include a cutoff at 30 cm depth. & \\
\hline
