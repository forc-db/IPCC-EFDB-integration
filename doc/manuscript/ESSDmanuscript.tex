...
(v4.0; described here). As of May 15, 2023, ForC contained
...
As of May 15, 2023, ForC contained 39855 records from 10589 plots in
...
records in ForC as of May 15, 2023, their addition gave the structure
...
and had not yet been completed for all records sent as of May 15, 2023.
...
As of May 15, 2023, ForC (v4.0) contained 32693 independent records
...
As of May 15, 2023, we had reviewed or added 2283 EFDB-relevant records,
...
under-represented regions and forest types (Figs. 2-3, Table 2), to
records from countries relying on existing data for their greenhouse gas
inventories (Tier 1 or 2 methodology), to the variables most needed by
EFDB users, and to the more contemporary records.
...
\citep{refs, labrière_forest_2023}. Other pools and variables remain
very poorly quantified \citep[Table
2,][]{anderson-teixeira_carbon_2021}, introducing substantive
uncertainties into global forest C budgets \citep{refs}. Furthermore,
data distribution is uneven across forest types and geographical regions
...
\citep{refs}, including through severe natural disturbance \citep{refs},
better characterization of forest dead wood will be critical.
Additionally, C stocks in forest organic horizons and soils can be quite
substantial and highly uncertain in many parts of the world
\citep{refs}. Significant investment in ground-based forest research
will be critical to filling these gaps.
...
potentially be useful for C accounting under IPCC guidelines. Here we
have developed a framework for transferring these records to the EFDB,
making them more accessible for forest C accounting under IPCC
guidelines \citep{ipcc_2006_2006, ipcc_2019_2019}. As of May 15, 2023,
...
of forest land records in EFDB. The records transferred to EFDB and
...
reporting results in ways that are compatible with IPCC guidelines
(Tables 1, 3). In addition, substantial investments in research and
researchers focused on ground-based measurement of forest C will be
required to fill knowledge gaps and thereby increase the accuracy of
forest C accounting. This challenge is heightened by the fact that
forests are changing rapidly \citep{refs}, and data collected a decade
or more in the past may no longer be relevant. This heightens the need
for an efficient system of making forest C data accessible for national
greenhouse gas inventories. We view this publication as one step towards
that goal.
...
data, BBL and SCP contributed large databases to ForC; HML and CP
provided methodological expertise; KAT, VH, and MW prepared the first
draft of the manuscript; all authors reviewed the results and approved
the final version of the manuscript.} %% optional section
