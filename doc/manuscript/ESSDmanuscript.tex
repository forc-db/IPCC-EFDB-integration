...
(v4.0; described here). As of May 06, 2023, ForC contained
...
As of May 06, 2023, ForC contained 39855 records from 10589 plots in
...
Although most of these variables lacked records in ForC as of May 06,
...
studies
\citep{piponiot_distribution_2022, lutz_largediameter_2021, refs} that
were not previously included in ForC. In addition, we created new
records for \textbf{\#\#} EFDB-relevant estimates presented in the
original publication that were not yet present in ForC.
...
records sent as of May 06, 2023.
...
As of May 06, 2023, ForC (v4.0) contained 32693 independent records
(39855 total), 17204 of which were for variables relevant to EFDB (Fig.
...
distributed across variables. The most records colected were for the
Aboveground biomass variable(biomass\_ag).This variable
...
As of May 06, 2023, we had reviewed or added 2034 EFDB-relevant records,
