...
because kableExtra doesn't seem to work in this template. Table that we
want here is ``figures\_tables/C\_pools.csv''})
...
\texttt{sample.bib}. Example citation
...
\begin{figure}
\includegraphics[width=12cm]{Nikolaus_Kopernikus} \caption{two column figure}\label{fig:unnamed-chunk-4}
\end{figure}
