...
C currently contains 39838 records from 10585 plots in 1531 distinct
...
required information, and added 305 new records.
...
We added a total of 15 new variables to the set of named and defined
variables, counting each pair of variables with units in C (ending in
\texttt{\_C}) or organic matter (ending in \texttt{\_OM}) as one. All of
these variables are relevant to C accounting under IPCC, and hence to
EFDB (Fig. 1). This included eleven increment variables, adding to only
one previously defined increment variable (aboveground biomass
...
Further, to provide better definition of the previously existing
variable \emph{organic.layer}, which has a nebulous definition that
reflects the varied definitions adopted by original studies, we added
two clearly defined variables: \emph{litter} (relatively undecomposed
plant material/ OL horizon), and \emph{O.horizon} (entire O-horizon,
including \emph{litter} (OL)).
...
In addition to reviewing existing records, we added a total of 305 new
...
records sent as of April 18, 2022.
...
4.1.1) and (2) determination of land use categories (section 4.1.2).
...
appropriately map them into the C pools and stock, stock changes,
increments, and losses (Fig. 1). As described in section 3.2, we also
defined 15 new EFDB-relevant variables that were not previously
represented. It it important to note that the correspondence of ForC
variables to IPCC criteria often depends upon measurement protocols
...
As of April 18, 2022, ForC (v4.0) contained NA independent records
(39838 total), NA of which were for variables relevant to EFDB (Fig. 1).
...
As of April 18, 2022, we had reviewed and sent NA, 73 of which have been
