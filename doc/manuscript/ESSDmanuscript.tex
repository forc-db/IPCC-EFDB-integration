...
new version of ForC (v4.0; described here). As of May 23, 2023, ForC
contained \textasciitilde19323 independent records relevant to EFDB,
...
estimates will be especially critical to accurate forest C inventories.
...
the data in ForC that's relevant to EFDB and records that have been
submitted to date; and (5) provide recommendations as to how the
scientific community can better provide useful data for forest C
inventories under the Paris Agreement.
...
records and had not yet been completed for all records sent as of May
23, 2023.
...
may vary by country, can make the data far more relevant estimating
forest C stock changes according to IPCC guidelines (e.g., using a 10 cm
cutoff between dead wood and litter, presenting soil C to a depth of 30
cm). It should also be emphasized that reporting of 95\% confidence
intervals (or other metrics of error), when applicable, is highly
desirable and makes the data more relevant to IPCC.
