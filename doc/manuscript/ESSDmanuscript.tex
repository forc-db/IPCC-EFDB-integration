...
The majority of information required by EFDB was present in previous
versions of ForC {[}{]}. We made modest structural changes to ForC
(Table \#\#) to allow complete records to be restructured for automated
population of EFDB data entry forms using R ().
...
\tightlist
\item
  Data location within source - Because EFDB will not accept data which
  has been digitized (from graphs) while ForC does, it was necessary to
  review and note the location of the data within the original source
\end{itemize}
