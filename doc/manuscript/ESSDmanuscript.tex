...
SOC. Increment records totaled 9\% of records sent, all for aboveground
biomass excepting 4 records for organic horizon increments. The
remaining (9\%) of records sent described fluxes, all of which were
either inputs or outputs to the aboveground biomass pool, and a subset
of which also described inputs to the dead wood or litter pool (Table 2,
Fig. 1).
