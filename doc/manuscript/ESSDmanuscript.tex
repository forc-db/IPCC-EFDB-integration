...
SOC. Increment records totaled 9\% of records sent, including 8.55\% for
aboveground biomass increments and 0.28\% for organic horizon
increments. The remaining (9\%) of records sent described fluxes, all of
which were either inputs or outputs to the aboveground biomass pool, and
a subset of which also described inputs to the dead wood or litter pool
(Table 2, Fig. 1).
