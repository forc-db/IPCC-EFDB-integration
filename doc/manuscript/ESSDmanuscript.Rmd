...
For each stratum of subdivision within a land-use category, annual stock changes ($\Delta C$; Mg C yr^-1^) are calculated as the sum of changes in various pools, including any harvested wood products.
