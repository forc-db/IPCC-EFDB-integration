...
While aboveground biomass stocks in particular have received -- and continue to receive -- by far the most research attention [Table `r table_variables`, @anderson-teixeira_carbon_2021], production of an accurate global map of forest C stocks remains an ongoing challenge [@refs; @labrière_forest_2023]. 
Other pools and variables remain very poorly quantified [Table `r table_variables`, @anderson-teixeira_carbon_2021], introducing substantive uncertainties into global forest C budgets [@refs].
...
Significant investment in research and researchers focused on ground-based measurement of forest C in such regions will be important to filling knowledge gaps in forest C cycling [@delima_making_2022;@refs].
...
Given observations of increasing tree mortality in some forested regions [@refs], including through severe natural disturbance [@refs], better characterization of forest dead wood will be critical.
Additionally, C stocks in forest organic horizons and soils can be quite substantial and highly uncertain in many parts of the world [@refs].
...
This challenge is heightened by the fact that forests are changing rapidly [@refs], and data collected a decade or more in the past may no longer be relevant.
