...
However, modest changes to the structure and contents of ForC were needed in order to provide all information fequired by EFDB and to improve ForC's capacity to serve as a repository of valuable information for forest C accounting under IPCC guidelines.
To support export of data to EFDB, and to improve the overall quality of the ForC database, we added ## new fields, defined ## new variables, implemented some modest restructuring (Table ##), resolved duplicate records, and conducted quality control.
...
Henceforth, we refer to the records with duplicates removed as "independent records".
