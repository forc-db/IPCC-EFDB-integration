...
\newpage 
**Table 1: variables with definitions and measurement methods.** Definitions from IPCC Table 1.1. (See Table 1.1 in IPCC guidance). (*Currently adding this as a figure (generated from original draft) because kableExtra doesn't seem to work in this template. Table that we want here is "figures_tables/C_pools.csv"*)
