...
do.call(file.remove, list(list.files("/Users/kteixeira/Dropbox (Smithsonian)/GitHub//Users/kteixeira/Dropbox (Smithsonian)/GitHub/ForC-db/IPCC-EFDB-integration/doc/manuscript/figures_tables", "World_Map_of_sites_with_FAO_and_IPCC_data_sent.png", full.names = TRUE))) # first remove old files
flist <- list.files("/Users/kteixeira/Dropbox (Smithsonian)/GitHub/ForC-db/ForC/figures/", "World_Map_of_sites_with_FAO_and_IPCC_data_sent.png", full.names = TRUE)
file.copy(flist, "/Users/kteixeira/Dropbox (Smithsonian)/GitHub/ForC-db/IPCC-EFDB-integration/doc/manuscript/figures_tables")
...
```{r fig_map, out.width = "15cm", echo = FALSE, fig.cap = "\\textbf{Map of sites in ForC shaded by number of records relavent to (circles) and transferred to (triangles) EFDB.} PLACEHOLDER. We need to add records transferred to EFDB. We also need to limit map to variables relavent to EFDB. It would also be good to add an underlying map of FAP ecozones"}
#this is for a two-column figure. for one-column figure, use {r, out.width = "8.3cm", echo = FALSE, fig.cap = "one column figure"}
knitr::include_graphics("figures_tables/World_Map_of_sites_with_FAO_and_IPCC_data_sent.png")
```

```{r fig_dominant_veg, out.width = "15cm", echo = FALSE, fig.cap = "\\textbf{Historgram of number of records in ForC relavent to (grey) and transferred to (black) EFDB.} PLACEHOLDER. We need to add axis labels and the two classes of records. "}
#this is for a two-column figure. for one-column figure, use {r, out.width = "8.3cm", echo = FALSE, fig.cap = "one column figure"}
