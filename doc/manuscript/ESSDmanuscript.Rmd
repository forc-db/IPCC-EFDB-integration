...
For each stratum of subdivision within a land-use category, annual stock changes ($\Delta C$; Mg C yr^-1^) are calculated as the sum of changes in various pools (section `r section_C_pools`), plus any harvested wood products.
...
The IPCC defines aboveground biomass as "all biomass of living vegetation, both woody and herbaceous, above the soil including stems, stumps, branches, bark, seeds, and foliage" [@ipcc_2006_2006].


Belowground biomass is defined as "all biomass of live roots" [@ipcc_2006_2006].
