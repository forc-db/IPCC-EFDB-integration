...
The International Panel on Climate Change (IPCC) provides guidance for national greenhouse gas inventories for reporting to the United Nations Framework Convention on Climate Change [UNFCCC, @ipcc_2019_2019].
...
For C currently contains **##** records from **##** plots in **##** distinct geographical areas, along with records of stand age and disturbance history.
