...
As of `r format(Sys.time(), '%B %d, %Y')`, ForC contained ~`r n_ind_records_EFDB_variables` independent records relevant to EFDB, `r n_records_sent_to_EFDB` of which have been submitted to date.
...
IPCC's guidance is that the understory may be excluded the understory if it constitutes a "minor" component [defined as < 25 - 30 % of emissions/removals for the overall category, @ipcc_2006_2006], and where a commonly applied minimum size sampling threshold for mature forests would be 10 cm stem diameter at breast height (DBH).
...
However, while equations for estimating root (and thereby total) biomass require improvement, they do exist for many forest types [e.g., @brassard_coarse_2011; @chojnacky_updated_2014;  @waring_overlooking_2017].
