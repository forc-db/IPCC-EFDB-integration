...
The majority of information required by EFDB was present in previous versions of ForC [].
We made modest structural changes to ForC (Table ##) to allow complete records to be restructured for automated population of EFDB data entry forms using R ().
