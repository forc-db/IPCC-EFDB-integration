...
Increment records totaled `r round(n_records_sent_increments/n_records_sent_to_EFDB*100, 0)`% of records sent, all for aboveground biomass excepting `r n_records_sent_delta.litter` records for organic horizon increments.
