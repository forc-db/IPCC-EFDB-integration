...
In regrowth forests, woodlands, or savannas, small trees and shrubs contribute a much larger proportion of C stocks and fluxes [@lutz_global_2018; @piponiot_distribution_2022; @refs_from_ForC], and, correspondingly, biomass estimates for these ecosystems tend include smaller size classes [e.g., @refs_from_ForC]. 
