...
For the latter, we *used an R script to automatically retrieve information based on the DOI ([issue 41](https://github.com/forc-db/IPCC-EFDB-integration/issues/41))*<!--needs info from Valentine here-->.  
