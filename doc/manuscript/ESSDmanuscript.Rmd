...
(1) whether data were presented in tables / text or digitized from figures (EFDB will not accept digitized data, whereas ForC does), 
(2) estimates in original units, 
and (3) confidence intervals (when not already in ForC).
