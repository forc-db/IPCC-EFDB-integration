...
To support export of data to EFDB, and to improve the overall quality of the ForC database, we added ## increment variables, implemented some modest restructuring, resolved duplicate records, and conducted quality control.
This section describes changes relative to ForC v2.0 [@anderson-teixeira_forc_2018].

## Increment variables
We added ## increment variables to the set of named and defined variables. 
