...
While aboveground biomass stocks in particular have received -- and continue to receive -- by far the most research attention [Table `r table_variables`, @anderson-teixeira_carbon_2021], production of an accurate global map of forest C stocks remains an ongoing challenge [@refs]. 
...
Although aboveground biomass is the most studied variable considered here (Table `r table_variables`) and is the target of satellite missions [@refs], significant ground-based research effort is required to create accurate global maps of forest biomass and changes therein [@refs].
