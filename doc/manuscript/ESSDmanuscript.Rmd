...
Tier 1 values have improved over the years as more of the relevant underlying data has become available [@requenasuarez_estimating_2019; @rozendaal_aboveground_2022], but there remains room for continuous improvement as the science advances and datasets grow and become more widely accessible.
...
(4) summarize the data in ForC that's relevant to EFDB and records that have been submitted to date; and
...
(1) presenting data only in a figure makes them ineligible for inclusion in EFDB, whereas presentation in a table or supplementary data file allows inclusion;
