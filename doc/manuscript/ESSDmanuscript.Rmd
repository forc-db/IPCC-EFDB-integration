...
As of `r format(Sys.time(), '%B %d, %Y')`<!--inserts date upon knit-->, we had reviewed and sent `r n_records_sent_to_EFDB` records to EFDB, `r n_records_posted_EFDB` of which have been reviewed, accepted, and posted (Fig. `r fig_map`-`r fig_dominant_veg`, Table `r table_variables`).
*[DETAILS]*
