...
For each stratum of subdivision within a land-use category (see **Land classification** section below), annual stock changes ($\Delta C$; t C yr^-1^) are calculated as the sum of changes in various pools (see **Carbon pools** section below), plus any harvested wood products.
