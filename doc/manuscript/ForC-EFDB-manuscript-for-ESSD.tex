...
is archived in Zenodo (DOI: TBD). The data and code associated with data
submission to EFDB and preparation of this manuscript are available via
the the IPCC-EFDB-integration repository within the ForC-db organization
on GitHub (https://github.com/forc-db/IPCC-EFDB-integration) and
archived in Zenodo (DOI:
