...
The IPCC inventory guidelines include specific instructions for inventories for greenhouse gas (mainly CO~2~) exchanges between forest land and the atmosphere [summarized in `r appendix_IPCC_definitions`, @ipcc_agriculture_2006; @ipcc_2019_2019].
...
With input from the IPCC's Technical Support Unit and referencing IPCC guidance [@ipcc_good_2003; @ipcc_2006_2006; @ipcc_2019_2019], we mapped ForC fields into EFDB fields, as summarized in `r table_ForCfieldmapping`.
