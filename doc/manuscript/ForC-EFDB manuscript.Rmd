...
For the majority of fields, contents of the field in ForC mapped directly into an EFDB field, either as the only contents of that field or as part of a composite record. <!--For example, ten ForC fields describing site location, climate, and edaphic properties all mapped into the EFDB field *Region/Regional conditions* (`r table_ForCfieldmapping`).-->
