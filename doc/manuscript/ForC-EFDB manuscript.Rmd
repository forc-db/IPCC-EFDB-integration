...
However, the efficacy climate change mitigation planning and reporting depends on having high quality of data on forest carbon (C) stocks and changes.
...
<!-- (2) methods-->
- The Global Forest C database (ForC) represents a compilation of tens of thousands of forest C estimates that is fully traceable and publicly available.
Here, we develop and document a process for semi-automated submission of data from ForC into the EFDB to help ensure that the EFDB has access to the best available data. We then assess the data available and provide recommendations for improving forest data collection, analysis, and reporting.
<!-- (3) key results-->
...
However, XX% of ForC records cannot be transferred because the original publication lacked the necessary information required by the IPCC.
<!-- (4) the main conclusion, including the key points of discussion-->
- In the future, forest C estimates should be targeted towards other carbon pools and tropical forests, and studies should ensure that they report all necessary information to enable data integration into the EFDB. 
