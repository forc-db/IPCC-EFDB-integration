...
To submit complete, reviewed ForC records tp EFDB, we created R scripts to restructure ForC records and populate EFDB's bulk import form (publicly available; see **Data Availability Statement**).
