...
We reviewed the list of ForC variables to identify those that were relevant to the IPCC methodology and to EFDB (`r appendix_IPCC_definitions`).
...
As described in section `r section_new_variables`, we also defined `r n_new_variables` new EFDB-relevant variables that were not previously represented in ForC (`r appendix_ForC_updates`). 
