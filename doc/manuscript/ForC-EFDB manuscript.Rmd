...
nocite: |
  @harris_updated_2014; @jung_exploiting_2006; @besnard_mapping_2021
---
...
ForC v4.0 records and the subset submitted to EFDB were distributed across all forested continents, biomes, and forest types, albeit unevenly (Figs. `r fig_map`-`r fig_histograms`).
...
The largest number of records came from mature forests (>100 years), followed by young and intermediate-aged stands, but young (<20 year) stands were best represented relative to their global area (Fig. `r fig_histograms`d).
