...
- if `distmrs.type`= "Burned", "StandClearing", or there's a missing value code, we don't know `PAST LAND-USE`. **See [this issue](https://github.com/forc-db/IPCC-EFDB-integration/issues/7)).**
